    ...
    <table class="table table-striped table-borderless">
        <thead>
            <tr>
                <?php
                echo "<th>No</th>";
                if ($this->session->level != 1) echo "<th><span class=''>Hapus</span></th>";
        ...
        <tbody>
            ...
            foreach ($table_content as $key => $value) {
                ...
                echo "<tr>";
                echo "<td>" . $no . "</td>";               
                if($this->session->level!=1)  echo "<td> <a class='text-danger' href='" . $page_url . "/deletion_delete/" . $value->status_id . "'><i class='fa fa-trash'> </i></a></td>";
